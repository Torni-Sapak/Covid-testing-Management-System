...
?>
                        <!-- Nav Item - Alerts -->
                        <li class="">
                            <a class="" href="#" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class=""></i>
                                <!-- Counter - Alerts -->
...
while($row=mysqli_fetch_array($query)){
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="test-details.php?tid=<?php echo $row['id'];?>&&oid=<?php echo $row['OrderNumber'];?>">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold"> <?php echo $row['OrderNumber'];?></span>
                                    </div>
                                </a>
                            <?php }} else{?>
...
?>
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php  echo $row1[''];?></span>
                           <?php } ?>
                                <img class=""
                                    src="">
                            </a>
