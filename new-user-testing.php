...
<form name="newtesting" method="post">
                            ...
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="GH-card / Driving License / Voter id / any other" required="true">
                                        </div>
                                        <div class="form-group">
 ...
 <div class="form-group">
                                      ...
                                      <select class="form-control" id="state" name="state" required="true">
                                            ...
                                            <option value="BonoEast Region">BonoEast Region</option>    
                                            <option value="Western North Region">WesternNorth Region</option>    
                                            <option value="Central Region">Central Region</option>    
                                            <option value="Ahafo Region">Ahafo Region</option>    
                                            <option value="NorthEast Region">NorthEast Region</option>    
                                            <option value="UpperEast Region">UpperEast Region</option>    
                                            <option value="UpperWest Region">UpperWest Region</option>    
