...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2>Prevention</h2>
  <ul>
            <li>Wash your Hands often with soap under running water</li>
            <li>Wear nose mask in public places</li>
            <li>Avoid contact with sick people</li>
            <li>Always cover your nose and mouth when coughing or sneezing</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; KTU FINAL YEAR STUDENTS(2021)</p>
    </div>
    <!-- /.container -->
  </footer>
