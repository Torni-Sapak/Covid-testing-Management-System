...
<head>
    ...
    <title>Covid-Tms | Regional Testing Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
  <?php include_once('includes/sidebar4.php');?>
        <!-- End of Sidebar -->
...
<?php include_once('includes/');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Regional Testing Live Update</h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Regional Testing Dashboard</h6>
                        </div>
                        <div class="card-body">
